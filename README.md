...
```
aws dynamodb create-table --table-name Jon3dSiteTable --attribute-definitions AttributeName=id,AttributeType=S --key-schema AttributeName=id,KeyType=HASH --billing-mode PAY_PER_REQUEST --endpoint-url http://127.0.0.1:8000
```
...
```
{
    "getByIdFunction": {
        ...
        "JON3D_SITE_TABLE": "Jon3dSiteTable"
    },
    "putItemFunction": {
        "ENDPOINT_OVERRIDE": "http://172.17.0.2:8000",
        "JON3D_SITE_TABLE": "Jon3dSiteTable"
...
aws dynamodb put-item \
    --table-name Jon3dSiteTable \
    --item '{"id": {"S": "A1234"}, "name": {"S": "randeepx"}}' \
    --endpoint-url http://127.0.0.1:8000
```
7. How to scan your table for items
```
aws dynamodb scan --table-name Jon3dSiteTable --endpoint-url http://127.0.0.1:8000
```
